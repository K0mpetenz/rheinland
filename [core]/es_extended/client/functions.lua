...
---@param message string Die Nachricht, die angezeigt werden soll
---@param notifyType? string Art der Notification: "info", "success", "error"
---@param length? number Dauer in Millisekunden (optional)
function ESX.ShowNotification(message, notifyType, length)
    local typ = notifyType or "info"
    local time = length or 5000
    TriggerEvent('NG-Notify:Alert', "System", message, time, typ)
end
