...
Config.Locale = "en"
Config.Currency = "€"
Config.NumberFormat = "de-DE" -- follows [language]-[country code]
...
Config.MinSpeedMphEjectionSeatbeltOff = 40.0
...
-- Vehicle Control
Config.VehicleControlKeybind = "F4"
...
Config.EngineToggleKeybind = true
Config.BoatAnchorKeybind = "M"
