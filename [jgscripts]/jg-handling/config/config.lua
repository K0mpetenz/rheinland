...
Config.EditorJobRestriction = {"dev"} -- [Requires framework] Enter jobs here that can use the editor, for example {"mechanic", "government"}. if set to false & EditorAdminOnly is also false, the editor will be public.
